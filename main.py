...
def main():
    ...
    # Инициализация парсеров с нормализованными марками
    parsers = [
        AvitoParser(normalize_make(make, "avito.ru"), model, year),
        AutoRuParser(normalize_make(make, "auto.ru"), model, year),
        DromParser(normalize_make(make, "drom.ru"), model, year)
    ]
